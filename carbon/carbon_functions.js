...
function initWindow() {
  ...
  option01.molecule = buckyball;
  option02.molecule = nanotube;
  option03.molecule = diamond;
  option04.molecule = graphite;
  option05.molecule = graphene_1;
  option06.molecule = graphene_2;
  
  // label each element
  option01.label = "Buckyball";			
  option02.label = "Nanotube";
  option03.label = "Diamond";
  option04.label = "Graphite";
  option05.label = "Graphene";
  option06.label = "Graphene (2)";
